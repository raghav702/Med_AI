            ...
            <CardContent className="pt-0">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="px-2 space-y-2">
                    <Slider
                      ...
                      aria-label="Minimum doctor rating"
                    />
                    <div className="flex justify-between text-xs text-gray-500">
                      <span>Any</span>
                      <span className="font-medium text-primary">
                        {localFilters.min_rating ? `${localFilters.min_rating}+ stars` : 'Any rating'}
                      </span>
                      <span>5 stars</span>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="px-2 space-y-2">
                    <Slider
                      value={[localFilters.max_price || 500]}
                      onValueChange={([value]) => 
                        handleFilterChange('max_price', value < 500 ? value : undefined)
                      }
                      max={500}
                      min={50}
                      step={25}
                    ...
                    <div className="flex justify-between text-xs text-gray-500">
                      <span>$50</span>
                      <span className="font-medium text-primary">
                        {localFilters.max_price ? `$${localFilters.max_price}` : '$500+'}
                      </span>
                      <span>$500+</span>
                    </div>
                  </div>
